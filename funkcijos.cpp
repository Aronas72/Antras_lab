...
void isvedimas(const list<Studentas>& vargsiukai, const list<Studentas>& galvociai, int rik, int balas, bool i_ekrana) {
    ...
    v.sort(lyg);
    g.sort(lyg);
    auto spausdinti_antrašte = [](std::ostream& os) {
        os << setw(15) << left << "Vardas" << setw(20) << left << "Pavarde"<< setw(5) << right << "ND1"<< setw(5) << right << "ND2"<< setw(5) << right << "ND3"<< setw(5) << right << "ND4"<< setw(5) << right << "ND5"<< setw(8) << right << "Egz."<< setw(18) << right << "Galutinis (Med.)"<< setw(18) << right << "Galutinis (Vid.)" << endl;
        os << string(104, '-') << endl;};
